...
{
    public class Touchpoint0000000104TopicListener : TopicListenerBase
    {
        private const string SubscriptionName = "0000000104";
        private const string TopicName = "0000000104";
        private const string AppIdUri = "Touchpoint0000000104.AppIdUri";
        private const string ClientUrl = "Touchpoint0000000104.Url";
        private const string FunctionName = "Touchpoint0000000104";
        ...
        public Touchpoint0000000104TopicListener(IListenersHelper listenersHelper)
        {
