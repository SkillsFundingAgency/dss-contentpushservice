...
{
    public class Touchpoint0000000106TopicListener : TopicListenerBase
    {
        private const string SubscriptionName = "0000000106";
        private const string TopicName = "0000000106";
        private const string AppIdUri = "Touchpoint0000000106.AppIdUri";
        private const string ClientUrl = "Touchpoint0000000106.Url";
        private const string FunctionName = "Touchpoint0000000106";
        ...
        public Touchpoint0000000106TopicListener(IListenersHelper listenersHelper)
        {
