...
{
    public class Touchpoint0000000109TopicListener : TopicListenerBase
    {
        private const string SubscriptionName = "0000000109";
        private const string TopicName = "0000000109";
        private const string AppIdUri = "Touchpoint0000000109.AppIdUri";
        private const string ClientUrl = "Touchpoint0000000109.Url";
        private const string FunctionName = "Touchpoint0000000109";
        ...
        public Touchpoint0000000109TopicListener(IListenersHelper listenersHelper)
        {
