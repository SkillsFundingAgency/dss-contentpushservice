...
{
    public class Touchpoint0000000202TopicListener : TopicListenerBase
    {
        private const string SubscriptionName = "0000000202";
        private const string TopicName = "0000000202";
        private const string AppIdUri = "Touchpoint0000000202.AppIdUri";
        private const string ClientUrl = "Touchpoint0000000202.Url";
        private const string FunctionName = "Touchpoint0000000202";
        ...
        public Touchpoint0000000202TopicListener(IListenersHelper listenersHelper)
        {
