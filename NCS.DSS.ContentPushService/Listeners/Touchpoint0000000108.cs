...
{
    public class Touchpoint0000000108TopicListener : TopicListenerBase
    {
        private const string SubscriptionName = "0000000108";
        private const string TopicName = "0000000108";
        private const string AppIdUri = "Touchpoint0000000108.AppIdUri";
        private const string ClientUrl = "Touchpoint0000000108.Url";
        private const string FunctionName = "Touchpoint0000000108";
        ...
        public Touchpoint0000000108TopicListener(IListenersHelper listenersHelper)
        {
