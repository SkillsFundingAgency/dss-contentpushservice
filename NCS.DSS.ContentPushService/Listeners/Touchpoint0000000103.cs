...
{
    public class Touchpoint0000000103TopicListener : TopicListenerBase
    {
        private const string SubscriptionName = "0000000103";
        private const string TopicName = "0000000103";
        private const string AppIdUri = "Touchpoint0000000103.AppIdUri";
        private const string ClientUrl = "Touchpoint0000000103.Url";
        private const string FunctionName = "Touchpoint0000000103";
        ...
        public Touchpoint0000000103TopicListener(IListenersHelper listenersHelper)
        {
