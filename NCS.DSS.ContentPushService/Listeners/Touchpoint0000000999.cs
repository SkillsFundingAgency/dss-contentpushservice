...
{
    public class Touchpoint0000000999TopicListener : TopicListenerBase
    {
        private const string SubscriptionName = "0000000999";
        private const string TopicName = "0000000999";
        private const string AppIdUri = "Touchpoint0000000999.AppIdUri";
        private const string ClientUrl = "Touchpoint0000000999.Url";
        private const string FunctionName = "Touchpoint0000000999";
        ...
        public Touchpoint0000000999TopicListener(IListenersHelper listenersHelper)
        {
