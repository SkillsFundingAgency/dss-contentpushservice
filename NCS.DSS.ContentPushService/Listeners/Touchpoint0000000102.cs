...
{
    public class Touchpoint0000000102TopicListener : TopicListenerBase
    {
        private const string SubscriptionName = "0000000102";
        private const string TopicName = "0000000102";
        private const string AppIdUri = "Touchpoint0000000102.AppIdUri";
        private const string ClientUrl = "Touchpoint0000000102.Url";
        private const string FunctionName = "Touchpoint0000000102";
        ...
        public Touchpoint0000000102TopicListener(IListenersHelper listenersHelper)
        {
