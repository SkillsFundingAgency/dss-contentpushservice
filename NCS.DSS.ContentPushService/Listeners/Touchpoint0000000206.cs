...
{
    public class Touchpoint0000000206TopicListener : TopicListenerBase
    {
        private const string SubscriptionName = "0000000206";
        private const string TopicName = "0000000206";
        private const string AppIdUri = "Touchpoint0000000206.AppIdUri";
        private const string ClientUrl = "Touchpoint0000000206.Url";
        private const string FunctionName = "Touchpoint0000000206";
        ...
        public Touchpoint0000000206TopicListener(IListenersHelper listenersHelper)
        {
